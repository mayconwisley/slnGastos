...
namespace Negocio.Movimento.Geral
{
    public class Inserir
    {
        ...
        public bool Cadastro(MovimentacaoObj movimentacao)
        {
            ...
            SQL.Append("INSERT INTO Movimentacao(DataMovimento, Descricao, Valor, TipoLancamento, TipoMonetario, TipoPagoRecebido, Integrado, Login, ClienteId, CompetenciaId, DataCadastro) ");
            SQL.Append("VALUES(@DataMovimento, @Descricao, @Valor, @TipoLancamento, @TipoMonetario, @TipoPagoRecebido, @Integrado, @Login, @ClienteId, @CompetenciaId, @DataCadastro)");
            try
            {
